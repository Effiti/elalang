...
enum ParserLoopResult { Continue, FinishedParsing, ParserError };
...
class Parser {
 ...
 private:
  ...
  void mParserError(Symbol expected, Token found);
  ...
  std::shared_ptr<Statements::VariableDefinitionStatement>
  mVariableDefinition();
